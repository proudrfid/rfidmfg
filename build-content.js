...
const COMPARISONS = [
  ...
  },
  {
    ...
    tables: [{ cap: 'Common HF/NFC chips compared', head: ['Chip', 'Memory', 'Security', 'Best for'], rows: [['NTAG213/215/216', '144–888 bytes', 'Basic, password', 'NFC tap, marketing, auth'], ['MIFARE Classic 1K/4K', '1–4 KB', 'CRYPTO1 (legacy)', 'Access, loyalty, closed transit'], ['MIFARE Ultralight', '48–192 bytes', 'Basic', 'Disposable tickets'], ['MIFARE DESFire EV2/EV3', '2–8 KB', 'AES, strong', 'Payment, transit, secure ID'], ['ICODE SLIX', '~1 KB', 'Basic', 'Library, long-range HF']] }, { cap: 'Data retention and write endurance (manufacturer datasheet values)', head: ['Chip', 'Data retention', 'Write endurance', 'Communication speed'], rows: [['NTAG213/215/216', '10 years', '100,000 cycles', '106 kbit/s'], ['MIFARE Classic 1K/4K (EV1)', '10 years', '200,000 cycles', '106 kbit/s'], ['MIFARE Ultralight EV1', '10 years', '100,000 cycles', '106 kbit/s'], ['MIFARE DESFire EV2/EV3', '25 years', '1,000,000 cycles', 'Up to 848 kbit/s'], ['ICODE SLIX/SLIX2', '50 years', '100,000 cycles', '26.5 kbit/s (ISO 15693)']] }],
...
if (!WD.length) {
  ...
  GUIDES.push({
    ...
    sections: [
      ...
      { h: 'Why some quotes are cheaper — and what to check before taking one', p: ['Big gaps between quotes for the "same" product almost always trace to the spec, not to margin. The usual reasons a quote comes in far below the ranges on this page: a compatible or clone chip instead of the original NXP, Impinj or EM part (works until a reader firmware update or a security feature does not); a smaller antenna or thinner substrate that quietly cuts read range and durability; skipped services — no per-unit read testing, no encoding, no artwork proof, no free samples; a stale price list that will be "corrected" at reorder time; or a trader quoting below cost to win the first order. None of these are visible in a price column.', 'To compare quotes fairly, fix three things and ask every supplier to match them: the exact chip part number (not just "MIFARE" or "UHF"), the construction (size, material, thickness, mounting), and the included services (testing, encoding, samples, warranty). If a supplier will not name the chip part number in writing, that is the answer. Our written quotes state all three, and the free pre-production samples exist so you can verify the chip on your own readers before any money is at risk.'] },
    ...
    faqs: [
      ...
      ['Why is another supplier cheaper than the ranges on this page?', 'Usually a spec difference you cannot see in the price column: a compatible chip instead of the original NXP/Impinj/EM part, a smaller antenna, thinner material, or skipped testing, encoding and samples. Ask for the exact chip part number and included services in writing, then compare like for like — and test free samples on your own readers before committing.'],
  ...
  },
  {
    ...
    table: { cap: 'Timeline at a glance', head: ['Stage', 'Typical time'], rows: [['Written quote', 'Within 24 hours'], ['Free pre-production samples', '3–7 days'], ['Artwork proof', 'Alongside samples'], ['Production start', 'Scheduled within 24 hours of approval + payment (working days, Beijing time)'], ['Bulk production', '7–30 days after approval, by product family'], ['Shipping', 'Express, tracked, door-to-door'], ['Warranty', '2 years']] },
    ...
    faqs: [
      ...
      ['When does production actually start after I pay?', 'Within 24 hours of the last confirmation — approved sample, approved artwork proof and payment received (working days, Beijing time). The bulk lead time on your quotation counts from that scheduling point, so nothing sits in a queue.'],
