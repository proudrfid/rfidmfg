...
(function () {
  ...
  // Floating quick-contact widget (injected on every page) — WhatsApp only;
  // the sticky header CTA already covers "Get a Quote" on desktop.
  ...
  // Motion policy v2: content is never hidden awaiting scroll.
  // Scroll-reveal and stat count-up animations were removed deliberately —
  // they blanked whole viewports mid-scroll and rendered hero stats as "0"
  // until intersection fired. Numbers are now server-rendered and static.
